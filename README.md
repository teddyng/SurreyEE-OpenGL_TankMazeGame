...
UPDATE 03/2022: Main code removed as requested by a lecturer of this modules who is also a friend of mine, have fun with your project. (I have also remove all commit history). I kept this here because I think it shows an interesting journey when I did this 5 years ago and now I work in IT (cyber security) which is complete different to the 'pure' EEE things I wanted to do when I started my degree.
...
Reminder: Plagiarism is a serious offense in force by the university, please refer to this code with care and at your own risk. This is only meant to be a guide and documentation for myself.
...
12am - Coursemate 3 missed the last bus back to Manor Park, so he explained about the head up display, it turns out to be very easy, because you just need to copy it from one of the tutorial. (I should have been doing the tutorials and not play games)
